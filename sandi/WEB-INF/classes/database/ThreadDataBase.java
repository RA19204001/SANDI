...
public class ThreadDataBase{
    ...
    try{
      ...
      if(theme.equals("1")){
        // System.out.println("if:"+theme);
      	getthred="SELECT thread_id, thread_name, thread_theme, thread_date, thread_description, thread_count FROM thread_table ORDER BY thread_count desc";
      }else{
        // System.out.println("if:"+theme);
      	getthred="SELECT thread_id, thread_name, thread_theme, thread_date, thread_description, thread_count FROM thread_table WHERE thread_theme='"+theme+"' ORDER BY thread_count desc";
      }
      //Statementインターフェイスを実装するクラスをインスタンス化する
      ...
      while(rst2.next()){
        ...
        description=con.conversionText(rst2.getString(5));
  ...
  public static List<ThreadListProfile> getNewThread(String theme){
    ...
    try{
      ...
      if(theme.equals("1")){
        // System.out.println("if:"+theme);
        getthred="SELECT thread_id, thread_name, thread_theme, thread_date, thread_description, thread_count FROM thread_table ORDER BY thread_date desc";
      }else{
        // System.out.println("if:"+theme);
        getthred="SELECT thread_id, thread_name, thread_theme, thread_date, thread_description, thread_count FROM thread_table WHERE thread_theme='"+theme+"' ORDER BY thread_date desc";
      }
      //Statementインターフェイスを実装するクラスをインスタンス化する
      Statement stt2=cn.createStatement();
      //select文を実行し
